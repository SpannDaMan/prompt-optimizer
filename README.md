...
> **Current release.** Prompt Optimizer `v0.1.7` makes its automatic more-than-three-relevant-sentences trigger explicit, preserves the operator-directed long-request example, and retains the genuine-transparent, larger safe-fill Agent Smith Palette identity across every plugin logo field.
