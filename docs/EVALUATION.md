...
The public `v0.1.4` candidate makes no model-performance, conversion, or task-quality claim. Its current automated evidence covers deterministic custody and fail-closed packet behavior only.
