...
- [ ] Create and verify `v0.1.6` with trigger-first provider metadata while preserving the accepted `v0.1.4` logo files.
- [ ] Test installation from the actual `v0.1.6` Git source and refresh supported provider listing metadata.
